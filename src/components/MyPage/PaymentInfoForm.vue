        ...
        <v-row class="member-row" >
          ...
          <v-row class="hi">
            <v-col cols="12">
              ...
              <v-text-field label="수령인" v-model="recipient"></v-text-field>
              <v-text-field label="연락처" v-model="phoneNumber"></v-text-field>
              <v-text-field label="배송메모" v-model="deliveryMemo"></v-text-field>
                          </v-col>
          </v-row>
